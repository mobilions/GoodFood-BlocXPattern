...
import 'package:sample_project/imports.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return AdvancedDrawer(
      ...
      controller: homeRepository.advancedDrawerController,
      ...
      childDecoration: const BoxDecoration(
        boxShadow: <BoxShadow>[
          BoxShadow(color: Color(0xFFF2EAEA), blurRadius: 99, spreadRadius: 0, offset: Offset(-25.0, 19.0)),
        ],
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        homeRepository.advancedDrawerController.showDrawer();
                      },
                      child: Container(
                        height: 38,
                        width: 38,
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: Color(0xFFE9EDF2).withOpacity(0.50),
                                      blurRadius: 30,
                      ...
                      //       return Padding(
                      //         padding:
                      //             EdgeInsets.only(right: getProportionateScreenWidth(14)),
                      ...
                      //                   controller.selectedCategory == index
                      //                       ? BoxShadow(
                      //                           color: Color(0xFFFE724C).withOpacity(0.251),
                      //                           blurRadius: 30,
                      //                           offset: Offset(0.0, 20.0),
                      //                         )
                      //                       : BoxShadow(
                      //                           color: Color(0xFFD3D1D8).withOpacity(0.251),
                      //                           blurRadius: 30,
                      //                           offset: Offset(0.0, 20.0))
                      //                 ]),
                      //             child: Column(
                        ...
                        child: Wrap(
                          ...
                          children: List.generate(
                            ...
                            (index) => GestureDetector(
                              onTap: () {
                                homeRepository.selectedCategory = index;
                                setState(() {});
                              },
                              child: Container(
                                padding: EdgeInsets.only(
                                  bottom: 19, left: 4.51, top: 4.51,
                                  right: 4.51,
                                  // bottom: getProportionateScreenHeight(19),
                                  // top: getProportionateScreenHeight(4.51),
                                  // left: getProportionateScreenWidth(4.51),
                                  // right: getProportionateScreenWidth(4.51),
                                ),
                                decoration: BoxDecoration(
                                    color: homeRepository.selectedCategory == index
                                        ? AppColors.primaryColor
                                        : Colors.white,
                                    borderRadius: BorderRadius.circular(100),
                                    boxShadow: [
                                ...
                                child: Column(
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          shape: BoxShape.circle,
                                          image: DecorationImage(image: AssetImage(AppImages.pizza))),
                                    ),
                                    SizedBox(
                                      height: getProportionateScreenHeight(8),
                                    ),
                                    Text(
                                      ...
                                      style: TextStyle(
                                          ...
                                          fontFamily: AppFonts.font500,
                                          color:
                                              homeRepository.selectedCategory == index ? Colors.white : Colors.black),
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            (index) => Container(
                              ...
                              child: Column(
                                children: [
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              // padding: EdgeInsets.symmetric(horizontal: getProportionateScreenWidth(8),vertical: 9,),
                                              decoration: BoxDecoration(
                                                color: Colors.white,
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  SizedBox(
                                                    width: getProportionateScreenWidth(4.2),
                                                  ),
                                                  Icon(
                                                    Icons.star,
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Container(
                                          height: 10,
                                          width: 10,
                                          decoration: BoxDecoration(shape: BoxShape.circle, color: Color(0xFF029094)),
                                          child: Icon(
                                            Icons.done,
                                            size: 6,
                                            color: Colors.white,
                                  ...
                                  //   children: [
                                  //     Container(
                                  //       padding: EdgeInsets.symmetric(vertical: getProportionateScreenHeight(3),horizontal: getProportionateScreenWidth(4)),
                                  //       decoration: BoxDecoration(
                                  //         borderRadius: BorderRadius.circular(5),
                                  //         color: Color(0xFFf6f6f6),),
                                  //       child: Text("Burger",style: TextStyle(fontSize: getProportionalFontSize(12),fontFamily: AppFonts.font400,color: Color(0xFF8A8E9B),),),
                                  //       ),
                                  //
                                  //   ],
                                  // )
                      ...
                      SingleChildScrollView(
                        ...
                        child: Wrap(
                          ...
                          children: List.generate(
                            ...
                            (index) => GestureDetector(
                              onTap: () {
                                // Get.toNamed(Routes.ORDERSDETAILS);
                              },
                              child: Container(
                                  ...
                                  children: [
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                              ...
                                              boxShadow: [
                                                BoxShadow(
                                                    blurRadius: 20,
                                                    color: Color(0xFFFE724C).withOpacity(0.20),
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        "Salmon Salad",
                                        style: TextStyle(
                                            fontSize: getProportionalFontSize(14), fontFamily: AppFonts.font500),
                                      ),
                                    ),
                                    SizedBox(
